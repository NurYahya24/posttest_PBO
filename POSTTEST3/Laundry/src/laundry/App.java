                        ...
                        if(pilih == 1){
                            ...
                            for(int i=0;i<dataset.size(); i++){
                                if(dataset.get(i).isOnline()){
                                    ...
                                    System.out.println("TOTAL BIAYA : " + dataset.get(i).getTotal());
                                    System.out.println("STATUS : " + dataset.get(i).getStatus());
                                    System.out.println("ALAMAT : " + dataset.get(i).getAlamat());
                                    System.out.println("=======================================");
                                }
                            }
                        ...
                        if(login.getEmail().equals(mail) & login.getPassword().equals(pw)){
                            while(kondisi){
                                ...
                                if(pilih==1){
                                    ...
                                    Laundry databaru = new Laundry(nama, 5, jenis, total, mail, "Sedang Dijemput", true, alamat);
                                    dataset.add(databaru);
                                }else if(pilih==2){
                                    System.out.println("\n\n=================STATUS PAKAIAN==================");
                                    for(int i = 0;i<dataset.size();i++){
                                        if(dataset.get(i).getMail().equals(login.getEmail())){
                                            System.out.println("Data Ke-" + (i+1));
                                            System.out.println("NAMA : " + dataset.get(i).getNama());
                                            System.out.println("BERAT PAKAIAN : " + dataset.get(i).getBerat());
                                            System.out.println("JENIS LAYANAN : " + dataset.get(i).getJenis_layanan());
