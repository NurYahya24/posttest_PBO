...
final public class App {
    public static void main(String[] args) throws NumberFormatException, IOException{
        ...
        ArrayList<Offline> dataset = new ArrayList<>();
                ...
                if(mail.equals(admin.getEmail()) & pw.equals(admin.getPassword())){
                    while(kondisi){
                        ...
                        if(pilih == 1){
                            ...
                            Offline new_data = new Offline(nama, qty, jenis, "Dalam Proses", false);
                            ...
                            if(select==1){
                                ...
                                for(int i=0;i<dataon.size(); i++){
                                    ...
                                    jenis = dataon.get(i).getJenis_layanan();
                                    if(jenis.equals("Wet Clean")){
                                        total = dataon.get(i).serviceType(true);
                                        System.out.println("TOTAL : " + total);
                                    }else{
                                        total = dataon.get(i).serviceType(false);
                                        System.out.println("TOTAL : " + total);
                                    }
                                    System.out.println("------------------------------------------");
                                }
                                for(int i=0;i<dataset.size(); i++){
                                    ...
                                    jenis = dataset.get(i).getJenis_layanan();
                                    if(jenis.equals("Wet Clean")){
                                        total = dataset.get(i).serviceType(true);
                                        System.out.println("TOTAL : " + total);
                                    }else{
                                        total = dataset.get(i).serviceType(false);
                                        System.out.println("TOTAL : " + total);
                                    }
                                    System.out.println("------------------------------------------");
                                }
                            ...
                            if(select==1){
                                ...
                                for(int i=0;i<dataset.size(); i++){
                                    ...
                                    jenis = dataset.get(i).getJenis_layanan();
                                    if(jenis.equals("Wet Clean")){
                                        dataset.get(i).serviceType(true);
                                    }else{
                                        dataset.get(i).serviceType(false);
                                    }
                            ...
                            if(select==1){
                                ...
                                select = Integer.parseInt(br.readLine());
                                select -=1;
                                Offline edit = dataset.get(select);
                        ...
                        if(login.getEmail().equals(mail) & login.getPassword().equals(pw)){
                            while(kondisi){
                                ...
                                if(pilih==1){
                                    ...
                                    Online databaru = new Online(alamat, nama, 5, jenis, mail, "Sedang Dijemput", true);
                                    dataon.add(databaru);
                                }else if(pilih==2){
                                    System.out.println("\n\n=================STATUS PAKAIAN==================");
                                    for(int i = 0;i<dataon.size();i++){
